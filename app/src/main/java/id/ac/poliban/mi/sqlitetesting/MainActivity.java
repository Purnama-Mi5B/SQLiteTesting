package id.ac.poliban.mi.sqlitetesting;
...
import id.ac.poliban.mi.sqlitetesting.dao.impl.FriendDaoImplSQLite;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getSupportActionBar()!=null) getSupportActionBar().setTitle("SQLite 1 Demo");
        ...
        Button btGetAllFriends = findViewById(R.id.btGetAllFriendS);
